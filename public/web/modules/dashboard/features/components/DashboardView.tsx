...
import { useDashboard } from '@/modules/dashboard/features/hooks/useDashboard';
import { useModules } from '@/modules/modules/features/modules/hooks/useModules'; // Importação do contexto de módulos
