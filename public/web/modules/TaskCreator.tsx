...
const TaskCreator: React.FC = () => {
  ...
  // Novos estados para Metas (Goals)
  ...
  // 1. Necessidade: De algo extra até questão de vida ou morte
  const getNecessityLabel = (v: number) => {
    if (v < 20) return "Opccional";
  ...
  // 2. Satisfação: Do "tanto faz" até "vai mudar minha vida"
  ...
  // 3. Frequência: De "uma vez na vida" até "rotina diária"
  const getFrequencyLabel = (v: number) => {
      ...
      <div className="flex-1 px-6 pb-40 overflow-y-auto no-scrollbar relative z-20">
        ...
        <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/50 dark:border-slate-800 rounded-[2.5rem] p-1 shadow-xl shadow-slate-200/50 dark:shadow-none animate-in fade-in slide-in-from-bottom-8 duration-700 delay-150">
          <div className="p-6 space-y-8">
            ...
            {/* --- VIEW: SONHOS (DREAM) - MANTIDO ORIGINAL --- */}
                ...
                <div className="flex gap-2 overflow-x-auto no-scrollbar pb-2">
                  {[
                    ...
                    <button
                      key={opt.val}
                      onClick={() =>
                        setRecurrence(opt.val as RecurrenceInterval)
                      }
            ...
            {!isShopping && !isNote && (
              <div className="space-y-4">
                ...
                {/* OPÇÃO 1: SELEÇÃO MANUAL (Padrão ou Modo Manual) */}
                ...
                {/* OPÇÃO 2: CALIBRAGEM AUTOMÁTICA (Apenas Metas + Modo Auto) */}
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <p className="text-[10px] text-slate-400 mt-1 max-w-[200px]">
                            O quanto isso é essencial para sua vida agora?
                          </p>
                        </div>
                        <span className="text-xs font-bold text-indigo-600 bg-indigo-50 dark:bg-indigo-900/30 px-3 py-1.5 rounded-xl border border-indigo-100 dark:border-indigo-800 min-w-[80px] text-center">
                      ...
                      <div className="relative pt-1">
                        <input
                          ...
                          className="w-full h-3 bg-slate-100 dark:bg-slate-800 rounded-full appearance-none cursor-pointer accent-indigo-600 hover:accent-indigo-500 transition-all focus:outline-none focus:ring-2 focus:ring-indigo-500/30"
                        />
                        <div className="flex justify-between text-[9px] font-bold text-slate-300 uppercase mt-2 px-1">
                          <span>Opcional</span>
                          <span>Vital</span>
                        </div>
                      </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <p className="text-[10px] text-slate-400 mt-1 max-w-[200px]">
                            O quanto concluir isso vai te realizar pessoalmente?
                          </p>
                        </div>
                        <span className="text-xs font-bold text-purple-600 bg-purple-50 dark:bg-purple-900/30 px-3 py-1.5 rounded-xl border border-purple-100 dark:border-purple-800 min-w-[80px] text-center">
                      ...
                      <div className="relative pt-1">
                        <input
                          ...
                          className="w-full h-3 bg-slate-100 dark:bg-slate-800 rounded-full appearance-none cursor-pointer accent-purple-600 hover:accent-purple-500 transition-all focus:outline-none focus:ring-2 focus:ring-purple-500/30"
                        />
                        <div className="flex justify-between text-[9px] font-bold text-slate-300 uppercase mt-2 px-1">
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <p className="text-[10px] text-slate-400 mt-1 max-w-[200px]">
                            Com que constância você precisará agir nisso?
                          </p>
                        </div>
                        <span className="text-xs font-bold text-cyan-600 bg-cyan-50 dark:bg-cyan-900/30 px-3 py-1.5 rounded-xl border border-cyan-100 dark:border-cyan-800 min-w-[80px] text-center">
                      ...
                      <div className="relative pt-1">
                        <input
                          ...
                          className="w-full h-3 bg-slate-100 dark:bg-slate-800 rounded-full appearance-none cursor-pointer accent-cyan-600 hover:accent-cyan-500 transition-all focus:outline-none focus:ring-2 focus:ring-cyan-500/30"
                        />
                        <div className="flex justify-between text-[9px] font-bold text-slate-300 uppercase mt-2 px-1">
                          <span>Uma vez</span>
                          <span>Diário</span>
                ...
                <textarea
                  ...
                  placeholder={
                    isNote
                      ...
                      : "Adicione descrições, links ou anotações importantes..."
                  }
                  rows={isNote ? 8 : 4}
