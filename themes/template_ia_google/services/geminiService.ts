...
export const getGhzAssistantInsights = async (
  ...
  // Feito por IA: Removida verificação manual de API Key e mensagens de UI sobre a chave,
  // conforme diretrizes (A chave é pré-configurada e o app não deve pedir ao usuário).
